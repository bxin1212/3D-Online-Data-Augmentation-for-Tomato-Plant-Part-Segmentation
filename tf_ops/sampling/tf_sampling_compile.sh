...
g++ -std=c++11 tf_sampling.cpp tf_sampling_g.cu.o -o tf_sampling_so.so -shared -fPIC -I$TF_INC -I /usr/local/cuda-11.2/include -I$TF_INC/external/nsync/public -lcudart -L /usr/local/cuda-11.2/lib64/ -L$TF_LIB -ltensorflow_framework -O2 #-D_GLIBCXX_USE_CXX11_ABI=0  
